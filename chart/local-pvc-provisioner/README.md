...
[Local Path Provisioner](https://github.com/szymonrychu/local-pvc-provisioner) provides a way for the Kubernetes users to
...
```console
$ git clone https://github.com/szymonrychu/local-pvc-provisioner.git
...
This chart bootstraps a [Local Path Provisioner](https://github.com/szymonrychu/local-pvc-provisioner) deployment on a
...
| ----------------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `image.repository`                  | Local Path Provisioner image name                                               | `szymonrychu/local-pvc-provisioner`                                                    |
